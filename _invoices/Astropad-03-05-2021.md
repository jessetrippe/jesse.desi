...
<table class="w-full mb-6">
	...
	<tbody id="invoice-tbody">
		...
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Build site banner</td>
			<td class="py-2 px-3 text-right" data-value="quantity">4</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Begin building newsletter signup</td>
			<td class="py-2 px-3 text-right" data-value="quantity">2</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Move Podcasts Posts to New Podcast page</td>
		...
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Video autoplay</td>
			<td class="py-2 px-3 text-right" data-value="quantity">5.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Page width & padding bug</td>
			<td class="py-2 px-3 text-right" data-value="quantity">2.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Launch & QA</td>
			<td class="py-2 px-3 text-right" data-value="quantity">1</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Updates to Play film & icon</td>
			<td class="py-2 px-3 text-right" data-value="quantity">1</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
