...
<table class="w-full">
	...
	<tbody id="invoice-tbody" class="divide-y border-b">
		<tr>
			...
			<td class="p-3 text-right" data-value="quantity">0.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Workbench product page overhaul (ACF fields, PHP template, CSS)</td>
			<td class="p-3 text-right" data-value="quantity">5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">App downloads iOS CTA and AJAX post loader improvements</td>
			<td class="p-3 text-right" data-value="quantity">1.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Tab Video ACF field and product page template improvements</td>
			<td class="p-3 text-right" data-value="quantity">1.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Launch, testing, and image cleanup</td>
