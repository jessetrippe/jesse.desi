...
<table class="w-full">
	...
	<tbody id="invoice-tbody" class="divide-y border-b">
		<tr>
			<td class="p-3">Workbench field restructure and template overhaul</td>
		...
		<tr>
			<td class="p-3">iOS downloads button and PHP 8 compatibility fixes</td>
			<td class="p-3 text-right" data-value="quantity">1.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Add tab video, layout refinements, and pricing toggle</td>
		...
		<tr>
			<td class="p-3">Optimize all site's images, update site to PHP 8</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Launch and fix missing images</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
