...
<div class="mb-6">
	<h1 class="font-bold uppercase mb-2">Invoice #8</h1>
...
<table class="w-full mb-6">
	...
	<tbody id="invoice-tbody">
		...
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Layout fixes spotted in production</td>
			<td class="py-2 px-3 text-right" data-value="quantity">.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Luna page Shopify/Buy Updates</td>
			<td class="py-2 px-3 text-right" data-value="quantity">3.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Launch and QA</td>
			<td class="py-2 px-3 text-right" data-value="quantity">1</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Change Site Navigation</td>
			<td class="py-2 px-3 text-right" data-value="quantity">3.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		...
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Beacon investigation</td>
			<td class="py-2 px-3 text-right" data-value="quantity">1</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">New homepage build</td>
			<td class="py-2 px-3 text-right" data-value="quantity">4.5</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Updates based on feedback</td>
			<td class="py-2 px-3 text-right" data-value="quantity">.75</td>
			<td class="py-2 px-3 text-right" data-value="price">75.00</td>
			<td class="py-2 px-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr class="border-gray-200 border-b-2">
			<td class="py-2 px-3">Move page into Wordpress</td>
