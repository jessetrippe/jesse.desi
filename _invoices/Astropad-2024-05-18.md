---
layout: invoice
title: "Astropad - 05-18-2024"
---

<div>
	<h1 class="font-bold uppercase mb-2">Invoice #14</h1>
	<p>May 18, 2024<br>
	Astro HQ LLC<br>
	P.O. Box 3347<br>
...
<table class="w-full">
	...
	<tbody id="invoice-tbody" class="divide-y border-b">
		<tr>
			<td class="p-3">Add FAQ section to Luna page</td>
		...
		<tr>
			<td class="p-3">Exclude Japanese posts from blog</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Convert fonts for Klaviyo forms</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Build/design Klaviyo forms</td>
			<td class="p-3 text-right" data-value="quantity">2.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Connect forms to appropriate list/segment</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Update Wordpress and plugins</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Launch changes and troubleshoot</td>
