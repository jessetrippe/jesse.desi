...
<table class="w-full">
	...
	<tbody id="invoice-tbody" class="divide-y border-b">
		...
		<tr>
			<td class="p-3">Layout fixes spotted in production</td>
			<td class="p-3 text-right" data-value="quantity">.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Luna page Shopify/Buy Updates</td>
		...
		<tr>
			<td class="p-3">Change Site Navigation</td>
			<td class="p-3 text-right" data-value="quantity">3.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		...
		<tr>
			<td class="p-3">Beacon investigation</td>
			<td class="p-3 text-right" data-value="quantity">1</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">New homepage build</td>
			<td class="p-3 text-right" data-value="quantity">4.5</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Updates based on feedback</td>
			<td class="p-3 text-right" data-value="quantity">.75</td>
			<td class="p-3 text-right" data-value="price">75.00</td>
			<td class="p-3 text-right font-bold" data-value="total"></td>
		</tr>
		<tr>
			<td class="p-3">Move page into Wordpress</td>
